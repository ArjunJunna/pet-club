...
export const EditProfileModal = ({
  ...
  return (
    <>
      ...
      >
        <div
          className="flex flex-col rounded gap-3 shadow-md bg-white dark:bg-gray-900 p-4 mt-16 w-3/4 sm:w-2/3 md:1/3 lg:w-1/4"
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            <div className="flex flex-col gap-1">
              <label
                htmlFor="name"
                className="font-semibold text-sm text-gray-500 dark:text-gray-300"
              >
                Fullname
              </label>
              <input
                type="name"
                value={fullName}
                className="text-gray-900 dark:text-gray-300 p-2 w-full rounded-lg bg-gray-200 dark:bg-gray-900 border border-gray-600"
                disabled
                required
              />
            </div>
